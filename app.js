...
{
    let apiURL = "https://api.unsplash.com/photos/random/?client_id=-qEAQEiK2wxq0jG-OJKhVZJgHNZnWwVYZoqaLbRrHZE&featured=true&orientation=landscape";
...
app.get("/search", async function(req, res)
{
   ...
   let apiURL = `https://api.unsplash.com/photos/random/?count=9&client_id=-qEAQEiK2wxq0jG-OJKhVZJgHNZnWwVYZoqaLbRrHZE&featured=true&orientation=landscape&query=${keyword}`;
   let response = await fetch(apiURL);
   let data = await response.json();
   let imageUrlArray = [];
